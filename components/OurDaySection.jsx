	...
	return (
		<section className={styles.wrapper} id="our-day">
			<div className={styles.container}>
				<h1 className={`${styles.title} ${customFont.className}`}>
					Sunday, 8 <sup>th</sup>{" "}
					<span className="text-hoverColor">December</span> 2024
				</h1>
				...
				<div>
					<p className={`${styles["main-part"]} ${customFont.className}`}>
						&quot;Our happily ever after starts soon.&quot;
					</p>
				</div>
			</div>
		</section>
